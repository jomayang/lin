  ...
  const handleUpdateModel = (newModel: number) => {
    ...
    switch (newModel) {
      ...
      case 3:
        ...
        break;
      case 4:
        setPreviewImage("24.jpg");
        break;
      case 5:
        setPreviewImage("4.jpg");
        break;
            ...
            <div className="w-full hidden md:block">
              <div className="my-4">
                ...
                <div className="grid gap-2 grid-cols-5 mt-2">
                  ...
                  <button onClick={() => setPreviewImage("24.jpg")}>
                    <Image src="/24.jpg" width={128} height={160} />
                  </button>
                  <button onClick={() => setPreviewImage("4.jpg")}>
                    <Image src="/4.jpg" width={128} height={160} />
                  </button>
                </div>
              </div>
              <div>
